...
elseif($_POST["uprava"] == "Upravit"){
  ...
  while($_POST["id_foto"][$j]){
    ...
    if($zdroj["kategorie"] != $_POST["galerie"][$j]){
      copy("../userfiles/galerie/".najdi_galerii($zdroj["kategorie"],"slozka")."/".$zdroj["foto"],"../userfiles/galerie/".najdi_galerii($_POST["galerie"][$j],"slozka")."/".$zdroj["foto"]);
      unlink("../userfiles/galerie/".najdi_galerii($zdroj["kategorie"],"slozka")."/".$zdroj["foto"]);
      copy("../userfiles/galerie/".najdi_galerii($zdroj["kategorie"],"slozka")."/nahledy/".$zdroj["foto"],"../userfiles/galerie/".najdi_galerii($_POST["galerie"][$j],"slozka")."/nahledy/".$zdroj["foto"]);
      unlink("../userfiles/galerie/".najdi_galerii($zdroj["kategorie"],"slozka")."/nahledy/".$zdroj["foto"]);
